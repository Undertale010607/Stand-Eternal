package net.undertaler.jojomod.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(JojoMod.MOD_ID);
    ...
    public static final DeferredBlock<Block> METEOR_ORE = registerBlock("meteor_ore",
